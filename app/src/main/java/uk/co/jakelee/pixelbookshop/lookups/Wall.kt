...
enum class Wall(
    ...
    BrickFrame(2, 2, R.string.wall_brickframe, 10, 1.0,
    ...
    BrickPartial(3, 3, R.string.wall_brickpartial, 10, 1.0,
    ...
    Brick(4, 4, R.string.wall_brick, 100, 1.1,
    ...
    BrickNoSupport(5, 5, R.string.wall_bricknosupport, 100, 1.1,
    ...
    BrickWindow(6, 6, R.string.wall_brickwindow, 100, 1.1,
    ...
    StoneSmall(7, 7, R.string.wall_stonesmall, 1000, 1.2,
    ...
    Stone(8, 8, R.string.wall_stone, 1000, 1.2,
    ...
    StoneHoles(9, 9, R.string.wall_stoneholes, 1000, 1.2,
    ...
    StoneWindow(10, 10, R.string.wall_stonewindow, 1000, 1.2,
