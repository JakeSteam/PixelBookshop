    ...
    companion object {
        ...
        suspend fun initialiseDatabase(database: AppDatabase) {
            ...
            database.ownedFloorDao().insert(
                ...
                OwnedFloor(2, 1, Floor.Wood),
                OwnedFloor(1, 1, Floor.Wood),
                OwnedFloor(0, 1, Floor.Wood),

                OwnedFloor(3, 2, Floor.Wood),
                OwnedFloor(2, 2, Floor.Wood),
                OwnedFloor(1, 2, Floor.Wood),
                OwnedFloor(0, 2, Floor.Wood),

                OwnedFloor(3, 3, Floor.Wood),
                OwnedFloor(2, 3, Floor.Wood),
                OwnedFloor(1, 3, Floor.Wood),
                OwnedFloor(0, 3, Floor.Wood),

                OwnedFloor(3, 4, Floor.Wood),
                OwnedFloor(2, 4, Floor.Wood),
                OwnedFloor(1, 4, Floor.Wood),
                OwnedFloor(0, 4, Floor.Wood),

                OwnedFloor(3, 5, Floor.Wood),
                OwnedFloor(2, 5, Floor.Wood),
                OwnedFloor(1, 5, Floor.Wood),
                OwnedFloor(0, 5, Floor.Wood),

                OwnedFloor(3, 6, Floor.Wood),
                OwnedFloor(2, 6, Floor.Wood),
                OwnedFloor(1, 6, Floor.Wood),
                OwnedFloor(0, 6, Floor.Wood)
            )
            database.ownedFurnitureDao().insert(
                ...
                OwnedFurniture(5, 3, 4, true, Furniture.TripleCandle),
                OwnedFurniture(6, 2, 4, true, Furniture.Chair),
                OwnedFurniture(7, 1, 4, true, Furniture.Bookcase),
                OwnedFurniture(8, 0, 4, true, Furniture.SmallCrate)
            )
