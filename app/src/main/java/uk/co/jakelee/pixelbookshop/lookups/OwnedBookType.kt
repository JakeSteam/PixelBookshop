...
enum class OwnedBookType(override val id: Int, @StringRes val title: Int, frequency: Double, val modifier: Double): Model {
    ...
    ReviewCopy(5, R.string.type_reviewcopy, 0.1, 1.0)
}